...
public interface ProductVariantRepository extends JpaRepository<ProductVariant, UUID> {
    ...
    @Query("SELECT v FROM ProductVariant v WHERE v.organizationId = :organizationId AND v.deletedAt IS NULL")
    ...
    @Query("SELECT v FROM ProductVariant v WHERE v.id = :id AND v.organizationId = :organizationId AND v.deletedAt IS NULL")
