...
public class GetOrganizationHandler implements QueryHandler<GetOrganizationQuery, OrganizationDTO> {
    ...
    public OrganizationDTO handle(GetOrganizationQuery query) {
        ...
        Organization org = orgRepo.findById(OrganizationId.of(query.organizationId()))
                .orElseThrow(() -> new OrganizationNotFoundException(OrganizationId.of(query.organizationId())));
